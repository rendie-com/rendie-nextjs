...
function GetE( elementId )//为(a)创建id返问
{//a="txtRows"
...
function SelectField( elementId )//让id为(a)的元素获得焦点
{//a="txtRows"
	var element = GetE( elementId ) ;//为(a)创建id返问
	element.focus() ;
	////focus() 设置对象输入焦点. 
...
* http://www.w3.org/TR/DOM-Level-3-Core/core.htm#Document3-renameNode
*/
