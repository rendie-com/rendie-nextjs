...
Rarr: [],//最后一次按下【右键的坐标】
    ...
    html: function () {
        this.obj.w = 1920; this.obj.h = 1080;//屏幕的宽高
    ...
    b06: function (t) {
        ...
        for (let i = 0; i < arr2.length; i++) {
            if (arr2[i].indexOf("◣") != -1) { num += parseInt(arr2[i].split("◣")[1]); }
            else if (arr2[i].indexOf("◤") != -1) { num += parseInt(arr2[i].split("◤")[1]); }
        }
        return num;
    },
    ...
    b13: function (txt)//摸眼
    {
        ...
        { this.d02(txt); }
        else { this.d02(txt.split(",")[0]); }//松开第一个按键
    },
    b14: function () {
        window.external.newFrom(0, 0);//按位创建【窗体】
        window.external.newDraw(0, 0);//按大小创建【画板】
        /*window.external.DrawRectangle(10,10,1900,1060)
...
this.b15();
Tool.Time(this.g01, 2000, this, "4");
    },
b15: function ()//普攻的范围圈
{

/*
let x1=parseInt(1920/2)//英雄中心X轴
let y1=parseInt(1080/2)-30//英雄中心Y轴
window.external.TranslateTransform(x1,y1)//移中心点
//window.external.RotateTransform(-4);
///////////////////【Q】///////////////////////////////////////
let Qw=940,Qh=780
x1+=0;y1+=62;
window.external.TranslateTransform(0,62)//移中心点
window.external.DrawString("【Q】",0,0)
window.external.DrawEllipse(-10,-10,20,20);//画中心点
window.external.DrawEllipse(-parseInt(Qw/2),-parseInt(Qh/2),Qw,Qh)
/////////////////////【4】//////////////////////////////////
let _4w=835,_4h=parseInt((Qh*_4w/Qw))//等比缩小
x1+=0;y1+=-14;//记录中心点
window.external.TranslateTransform(0,-14)//移中心点
window.external.DrawString("【4】",0,0);
window.external.DrawEllipse(-10,-10,20,20);//画中心点
window.external.DrawEllipse(-parseInt(_4w/2),-parseInt(_4h/2),_4w,_4h)
///////////////////【E】////////////////////////////
Ew=463,Eh=parseInt((Qh*Ew/Qw))//等比缩小
x1+=0;y1+=-37;//记录中心点
window.external.TranslateTransform(0,-37)//移中心点
window.external.DrawString("【E】",0,0)
window.external.DrawEllipse(-10,-10,20,20);//画中心点
window.external.DrawEllipse(-parseInt(Ew/2),-parseInt(Eh/2),Ew,Eh)//
///////////////////【A】///////////////////////////////
let Aw=254,Ah=parseInt((Qh*Aw/Qw))
x1+=0;y1+=-11;//记录中心点
window.external.TranslateTransform(0,-11)//移中心点
window.external.DrawEllipse(-10,-10,20,20);//画中心点
window.external.DrawString("【A】",0,0)
window.external.DrawEllipse(-parseInt(Aw/2),-parseInt(Ah/2),Aw,Ah)
////////////////////////////////////////////////
window.external.TranslateTransform(-x1,-y1)//恢复中心点*--/
this.b16();
},
b16: function () {
/*let x1=1920-270,y1=1080-270,mw=200,mh=200;
window.external.TranslateTransform(x1,y1)//移中心点
window.external.DrawRectangle(0,0,260,260)//小地图矩形
window.external.DrawEllipse(-10,-10,20,20);//小地图【上】圆心
window.external.DrawEllipse(-parseInt(mw/2),-parseInt(mh/2)+260,mw,mh);//小地图【下】圆
window.external.DrawEllipse(-parseInt(mw/2)+260,-parseInt(mh/2),mw,mh);//小地图【上】圆
window.external.RotateTransform(-45);//旋转相应的角度(绕当前原点)
window.external.DrawRectangle(-14,70,30,104)//小地图河道矩形【上】
window.external.DrawRectangle(-14,195,30,104)//小地图河道矩形【下】
window.external.RotateTransform(45);
window.external.TranslateTransform(-x1,-y1)//恢复中心点*--/
this.b17();
},
b17: function () {
let x1 = parseInt(1920 / 2) + 300//英雄中心X轴
let y1 = parseInt(1080 / 2)//英雄中心Y轴
window.external.TranslateTransform(x1, y1)//移中心点
let LineL = 300
/////////////////////////////////////////
window.external.DrawLine(0, 0, LineL, 0)
//////////////////////////////////////////
window.external.DrawLine(50, 0, 50, -LineL)
window.external.DrawString("50", 42, -LineL - 15)
window.external.DrawLine(100, 0, 100, -LineL)
window.external.DrawString("100", 88, -LineL - 15)
window.external.DrawLine(150, 0, 150, -LineL)
window.external.DrawString("150", 138, -LineL - 15)
window.external.DrawLine(200, 0, 200, -LineL)
window.external.DrawString("200", 188, -LineL - 15)
window.external.FillPolygon(LineL + ",-10|" + (LineL + 30) + ",0|" + LineL + ",10");
window.external.DrawString("X", LineL + 30, -5)
/////////////////////////////////////////////
window.external.DrawLine(0, 0, 0, -300)
window.external.DrawLine(0, -50, LineL, -50)
window.external.DrawString("50", LineL + 5, -55)
window.external.DrawLine(0, -100, LineL, -100)
window.external.DrawString("100", LineL + 5, -105)
window.external.DrawLine(0, -150, LineL, -150)
window.external.DrawString("150", LineL + 5, -155)
window.external.DrawLine(0, -200, LineL, -200)
window.external.DrawString("200", LineL + 5, -205)
window.external.FillPolygon("-10,-300|0,-330|10,-300");
window.external.DrawString("Y", -5, -345)
//////////////////////////////////////////////
//Math.sqrt(Math.pow(300,2)+0+Math.pow(300,2))//轴心到点的距离=√x^2+y^2+z^2

let c = 300, o1 = 45
let x2 = parseInt(Math.cos(o1) * c)//对边为a,斜边为c,角度为g 。公式为：【a/c=sin g】;注：c是斜边。
let y2 = parseInt(Math.sin(o1) * c)
window.external.DrawLine(0, 0, -x2, y2)
window.external.FillPolygon((-x2 + 10) + "," + y2 + "|" + (-x2) + "," + (y2 + 10) + "|" + (-x2 - 10) + "," + y2);
window.external.DrawString("Z", -x2 + 5, y2 + 5)
window.external.DrawLine(50, 0, -x2 + 50, y2)
window.external.DrawString("50", -x2 + 50 - 10, y2)
window.external.DrawLine(100, 0, -x2 + 100, y2)
window.external.DrawString("100", -x2 + 100 - 14, y2)
window.external.DrawLine(150, 0, -x2 + 150, y2)
window.external.DrawString("150", -x2 + 150 - 14, y2)
window.external.DrawLine(200, 0, -x2 + 200, y2)
window.external.DrawString("200", -x2 + 200 - 14, y2)

//////////////////////////////////////////////
c = 50
x2 = parseInt(Math.cos(o1) * c)//对边为a,斜边为c,角度为g 。公式为：【a/c=sin g】;注：c是斜边。
y2 = parseInt(Math.sin(o1) * c)
window.external.DrawLine(-x2, y2, 300 - x2, y2)
window.external.DrawString("50", 300 - x2, y2 - 8)
c = 100
x2 = parseInt(Math.cos(o1) * c)//对边为a,斜边为c,角度为g 。公式为：【a/c=sin g】;注：c是斜边。
y2 = parseInt(Math.sin(o1) * c)
window.external.DrawLine(-x2, y2, 300 - x2, y2)
window.external.DrawString("100", 300 - x2, y2 - 8)
c = 150
x2 = parseInt(Math.cos(o1) * c)//对边为a,斜边为c,角度为g 。公式为：【a/c=sin g】;注：c是斜边。
y2 = parseInt(Math.sin(o1) * c)
window.external.DrawLine(-x2, y2, 300 - x2, y2)
window.external.DrawString("150", 300 - x2, y2 - 8)
c = 200
x2 = parseInt(Math.cos(o1) * c)//对边为a,斜边为c,角度为g 。公式为：【a/c=sin g】;注：c是斜边。
y2 = parseInt(Math.sin(o1) * c)
window.external.DrawLine(-x2, y2, 300 - x2, y2)
window.external.DrawString("200", 300 - x2, y2 - 8)
//////////////
...
c11: function (t) {
if (t.indexOf("找图片次数超限") != -1) { $("#code").html(t); }
else {
    $("#code").html("等级:" + t);
    eval("let arr=" + t);
...
{
  //       [松开4][     Q    ][   空格    ] [  右键  ]
  //this.b13("52◤50,81◣50,81◤50,32◣250,32◤50,R◣50,R◤10");
}
...
d03: function (str) { win.KeyArr(str); },
d04: function ()//执行完了.
{
this.isLock = false;
$("#code").html($("#code").html() + "\n返回值：\n" + window.external.Img + "\n");
...
if (t.indexOf("找图片次数超限") != -1) {
    ...
    eval("let arr=" + t);
    if (arr.length <= 3) { this.obj.code[0].equipment1 = 1; }
    else { this.obj.code[0].equipment1 = 2; }
}
...
if (t.indexOf("找图片次数超限") != -1) {
    ...
    eval("let arr=" + t);
    if (arr[0] == "") { this.obj.code[0].equipment4 = false; }
    else { this.obj.code[0].equipment4 = true; }
    if (arr[1] == "") { this.obj.code[0].equipment5 = false; }
    else { this.obj.code[0].equipment5 = true; }
}
...
//                [  Q飞行0.45秒    ]
$("#code").html($("#code").html() + "\n要执行：" + arr[0])
//window.external.KeyArr(arr[0]);
this.isLock = false;
//Tool.Time(this.f02,this.b06(arr[0]),this,"3",arr);
},
f02: function (arr) {
this.isLock = false;
$("#code").html($("#code").html() + "\n返回值：\n" + window.external.Img + "\n");
...
if (t.indexOf("找图片次数超限") == -1) {
    ...
    if (arr2[0].length == 1 && arr2[1].length >= 1)//如果同时找到了，【我】和【他】
    {
        ...
        for (let i = 0; i < arr2[1].length; i++)//有多个【他】
        {
            ...
            //arr2[1][i][2]=this.bxxxxx15(arr2[1][i][0],arr2[1][i][1])//返回斜边长度，
        }
        this.f04(arr2, arr3);
    }
}
...
g01: function () {
$("#code").html("正在截图。。。");
//window.external.newScreenImg("League of Legends (TM) Client");
//window.external.newScreenImg("WeGame");
Tool.Time(this.g02, 50, this, "4");
},
g02: function () {
if (window.external.isScreenImg) {
    //参数：
    //  图片：  多个图片用“|”隔开。
    //  x：   从X轴开始找
    //  y：   从Y轴开始找
    ...
    //  单选/多选:0单选;1多选；（默认：0单选）
    $("#code").html("正在找图【我】【他】。。。");
    window.external.FindImg("英雄联盟/英雄/我.bmp|英雄联盟/英雄/他.bmp,0,0,0,0,0,1");
    Tool.Time(this.g03, 50, this, "4");
}
else { Tool.Time(this.g01, 1000, this, "4"); }
},
g03: function () {
let t = window.external.Img
if (t && t != "[[],[]]") {
    $("#code").html("正在画图。。。" + t);
    eval("let arr=" + t)
    window.external.newDraw(0, 0);//按大小创建【画板】
    if (arr[0][0])//如果同时找到了【我】
    {
        //X轴+70；Y轴+160；就是中心位置
        let x1 = 70, y1 = 160, x2 = 0, y2 = 0
        //if(this.Rarr[0]){window.external.DrawLine(arr[0][0][0]+x1,arr[0][0][1]+y1,this.Rarr[0],this.Rarr[1]);}
        ///////////////////////////////////////////////////////
        if (arr[1][0])//如果同时找到了【他】
        {
            for (let i = 0; i < arr[1].length; i++) {
                x2 = arr[1][i][0] + x1
                y2 = arr[1][i][1] + y1 - 50
                window.external.DrawLine(arr[0][0][0] + x1, arr[0][0][1] + y1, x2, y2)
                window.external.DrawString("【他】", x2, y2)
                window.external.DrawEllipse(x2 - 10, y2 - 10, 20, 20);//画中心点
                ////////////////////////////////////////////////////
                let Aw = 50, Ah = 50
                window.external.DrawEllipse(x2 - parseInt(Aw / 2), y2 - parseInt(Ah / 2), Aw, Ah)
            }
        }
    }
    this.b15();
    Tool.Time(this.g01, 50, this, "4");
}
else { Tool.Time(this.g03, 50, this, "4"); }
},
//|英雄联盟/英雄/小地图/武器大师-下边.bmp|英雄联盟/英雄/小地图/武器大师-右边.bmp
...
//win.ImgChkTime("",1,250,this.g02,this,"",0,"League of Legends (TM) Client");
*/