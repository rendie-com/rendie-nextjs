...
Object.assign(Tool, {
    SignIn:
    {
        ...
        a02: function (t, arr) {
            let str = '\
            {<r:seller db="sqlite.pinduoduo" size=1 where=" where @.id='+ arr[0] + '">\
        ...
        a03: function (oo, arr) {
            ...
            Tool.loginPinduoduo.a01(oo.username, oo.password, oo.cookies, oo.pifauser, arr[1], this.a04, this, arr)
        },
        a04: function (t, arr) {
            let url = "https://mms.pinduoduo.com/mallcenter/changeAccountInfo/accountSetting/accountInfo"
            arr[1].html("正在打开页面...");
