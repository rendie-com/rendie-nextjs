...
var fun =
{
    ...
    a02: function (id) {
        let str = '{\
        <r:seller db="sqlite.pinduoduo" size=1 where=" where @.id='+ id + '">\
          "sort":<:sort/>,\
          "fromid":<:fromid/>,\
    ...
    a03: function (oo) {
        ...
        <div class="p-2">\
          <table class="table table-hover align-middle" id="div1">\
            <tbody>\
            <tr>\
              <td class="w150 right">店铺编号：</td>\
              <td><input type="text" class="form-control" value="'+ oo.fromid + '" onblur="fun.c01($(this),\'fromid\',\'' + oo.fromid + '\')"></td>\
              <td></td>\
            </tr>\
            <tr>\
              <td class="w150 right">批发用户名：</td>\
              <td><input type="text" class="form-control" value="'+ oo.pifauser + '" onblur="fun.c01($(this),\'pifauser\',\'' + oo.pifauser + '\')"></td>\
              <td></td>\
            </tr>\
            <tr>\
    ...
    c01: function (This, L, V) {
        ...
        if (val != V && !This.attr("disabled")) {
            ...
            let txt = '""<r: db="sqlite.pinduoduo">update @.seller set @.' + L + '=\'' + val + '\' where @.id=' + obj.arr[4] + '</r:>'
