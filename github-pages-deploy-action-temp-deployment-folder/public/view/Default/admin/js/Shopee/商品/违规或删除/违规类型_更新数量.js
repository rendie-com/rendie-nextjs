var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header(obj.params.return, 'Shopee &gt; 商品列表 &gt; 违规或删除 &gt; 违规类型_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let data = [{
            ...
            sql: "select count(1) as total from @.table where @.penalty_type=" + (this.obj.A1 - 1),
        }]
        $("#state").html("正在统计数量");
    ...
    a05: function () {
        ...
        config.bannedPro_penalty_type_count = this.obj.Aarr;
        let data = [{
            action: "fs",
            fun: "writeFile",
