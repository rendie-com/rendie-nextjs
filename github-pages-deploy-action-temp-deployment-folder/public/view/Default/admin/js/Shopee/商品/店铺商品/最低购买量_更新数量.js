var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header('Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 最低购买量_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let html = '<.Db(sqlite.shopee,select count(1) as total from @.shopPro_' + obj.arr[5] + ' where @.MinimumOrder' + (this.obj.Aarr[this.obj.A1 - 1][0] == 10 ? '>=10' : '=' + this.obj.Aarr[this.obj.A1 - 1][0]) + ',count)/>'
        $("#state").html("正在统计数量");
    ...
    a05: function () {
        config[obj.arr[5]].shopPro_MinimumOrder_count = this.obj.A2arr;
