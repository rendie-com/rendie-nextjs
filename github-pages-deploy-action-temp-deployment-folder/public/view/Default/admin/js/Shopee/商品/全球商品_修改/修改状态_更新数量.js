var fun =
{
    ...
    a01: function () {
        let html = Tool.header(obj.params.return, 'Shopee &gt; 商品列表 &gt; 全球商品_修改 &gt; 修改状态_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let data = [{
            ...
            sql: "select count(1) as total from @.table where @.editStatus=" + Tool.GlobalPro_editStatus[this.obj.A1 - 1][0],
        }]
        $("#state").html("正在统计数量");
