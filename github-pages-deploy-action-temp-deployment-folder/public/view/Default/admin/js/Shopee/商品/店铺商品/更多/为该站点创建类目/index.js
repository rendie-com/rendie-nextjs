...
var fun =
{
    a01: function () {
        ...
        <div class="p-2">\
          ...
          <tbody>\
		    <tr><td class="w200 right">获取站点：</td><td colspan="2">'+ Tool.site(obj.params.site) + '</td></tr>\
    ...
    a03: function (t) {
        //删除站点类目
        Tool.common_delete_category.a01(t, obj.params.site, obj.params.num, this.a04, this, t)
    },
    a04: function (t) {
        //创建最低购买数量类目
        Tool.common_create_MinimumOrder_category.a01(t, obj.params.site, obj.params.num, this.a05, this, t);
    },
    a05: function (t) {
        //创建价格类目
        Tool.common_create_price_category.a01(t, obj.params.site, obj.params.num, this.a06, this, t);
    },
    a06: function (t) {
        //创建热门关键词类目
        Tool.common_create_key_category.a01(t, obj.params.site, obj.params.num, this.a07, this, t);
    },
    a07: function (t) {
        //创建新品类目
        Tool.common_create_NewArrival_category.a01(t, obj.params.site, obj.params.num, this.a08, this, t);
    },
    a08: function (t) {
        $("#state").html("全部完成。。。")
    },
