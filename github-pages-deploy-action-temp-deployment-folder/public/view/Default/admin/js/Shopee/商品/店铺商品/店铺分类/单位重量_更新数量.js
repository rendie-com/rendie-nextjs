var fun =
{
    ...
    a01: function () {
        ...
        //obj.params.site            站点
        let html = Tool.header(obj.params.return, 'Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 单位重量_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        ...
        let data = [{
            ...
            sql: "select count(1) as total from @.table where @.unitWeight>" + (this.obj.Aarr[this.obj.A1 - 1][2] / 1000) + where,
        }]
        $("#state").html("正在统计数量");
    ...
    a05: function () {
        config[obj.params.site].shopPro_unitWeight_count = this.obj.A2arr;
        let data = [{
            action: "fs",
            fun: "writeFile",
