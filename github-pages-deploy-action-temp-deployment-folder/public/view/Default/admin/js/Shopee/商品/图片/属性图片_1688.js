...
var fun =
{
    ...
    a02: function () {
        let data = [{
            action: "sqlite",
            database: "shopee_img",
            sql: "select count(1) as total FROM @.attrpic_1688" + this.b06(),
        }, {
            action: "sqlite",
            database: "shopee_img",
            sql: "select " + Tool.fieldAs("id,fromid,hash,width,height,size,addtime,src,my_watermark,br_watermark") + " FROM @.attrpic_1688" + this.b06() + Tool.limit(10, obj.params.page),
        }]
    ...
    a03: function (t) {
        ...
        <div class="p-2">\
            ...
            <ul class="makeHtmlTab" id="picTab" style="padding-left: 20px;">\
                <li onclick="Tool.main(\'?jsFile=js28&table=pic1\')">首图_aliexpress</li>\
                <li onclick="Tool.main(\'?jsFile=js28&table=pic\')">放大镜图片_aliexpress</li>\
                <li onclick="Tool.main(\'?jsFile=js28&table=attrpic_aliexpress\')">属性图片_aliexpress</li>\
                <li onclick="Tool.main(\'?jsFile=js30\')" class="hover">属性图片_1688</li>\
                <li onclick="Tool.main(\'?jsFile=js28&table=despic\')">详情图片_aliexpress</li>\
            </ul>\
            '+ this.b04() + '\
    ...
    b01: function () {
        ...
        <ul class="dropdown-menu">\
            <li onClick="Tool.open4(\'js07\');"><a class="dropdown-item pointer">*把【全球商品】的图片上传到Shopee平台</a></li>\
            <li onClick="Tool.open4(\'js29\');" title="使用1688属性图：1688 &gt; 采集箱 &gt; 【1688】主商品列表 &gt; 手动审核1688状态 &gt; 使用1688属性图"><a class="dropdown-item pointer">*把【使用1688属性图】上传到Shopee平台</a></li>\
        </ul>'
    },
    b02: function (pic) {
        if (pic) {
