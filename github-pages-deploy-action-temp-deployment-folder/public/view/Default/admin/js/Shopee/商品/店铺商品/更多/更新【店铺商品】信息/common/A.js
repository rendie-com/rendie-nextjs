...
Object.assign(Tool, {
    common_A:
    {
        ...
        a04: function (oo) {
            let url = 'https://seller.shopee.cn/portal/product/' + oo.shop_product.fromid + '?cnsc_shop_id=' + oo.seller[oo.site][Tool.int(oo.num) - 1].shopId
            let html = '\
        ...
        a05: function (t, oo) {
            ...
            Tool.common_price.a01(
                oo.seller.logistics,
                oo.seller[oo.site][Tool.int(oo.num - 1)],
                t.sku,
                t.freight,
        ...
        a07: function (t, oo) {
            oo.edit_watermark = t;
            Tool.edit_model_list.a01(JSON.parse(oo.shop_product.model_list), t.attrPic, oo.seller, oo.site, oo.num, oo.global_product_and_1688_product.global_product.fromid, oo.shop_product.fromid, this.a08, this, oo)
        },
        a08: function (t, oo) {
            $("#tbody").append('\
        ...
        a09: function (oo) {
            this.obj.A1++;
            this.a01(oo.seller, oo.site, oo.num);
        },
        ////////////////////////////////////////////////////////////
        b01: function (mode) {
