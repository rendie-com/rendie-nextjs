...
var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header(o.params.return, "Shopee &gt; 订单 &gt; 订单管理 &gt; 更多 &gt; 获取订单信息") + '\
        <div class="p-2">\
          <table class="table table-hover align-middle mb-0">\
          <tbody>\
		    <tr><td class="w150 right">获取站点：</td><td colspan="2">'+ Tool.site(o.params.site) + '</td></tr>\
    ...
    d03: function () {
        ...
        $("#state").html("获取订单信息");
        Tool.get_one_order.a01(Barr.order_id, this.obj.seller, o.params.site, o.params.num, this.d04, this, Barr);
    },
    d04: function (t, Barr) {
        Barr.order = t;
        Tool.get_order_income_components.a01(Barr.order_id, this.obj.seller, o.params.site, o.params.num, this.d05, this, Barr);
    },
    d05: function (t, Barr) {
        ...
        Tool.get_logistics_tracking_history.a01(Barr.order_id, this.obj.seller, o.params.site, o.params.num, this.d06, this, Barr);
    },
    d06: function (t, Barr) {
        ...
        $("#state").html("国内运单信息");
        Tool.get_order_fm_code_multi_shop.a01(Barr.order_id, Barr.order["@.order_sn"], Barr.order.package_number, this.obj.seller, o.params.site, o.params.num, this.d07, this, Barr);
    },
    d07: function (t, Barr) {
        $("#state").html("更新或添加订单信息");
        Barr.order["@.DomesticWaybill"] = Tool.rpsql(JSON.stringify(t))//国内运单号（如：json）
        Tool.updateOrInsert_orders.a01(Barr.order, o.params.site, o.params.num, this.d08, this);
    },
    d08: function () {
        this.obj.B1++;
