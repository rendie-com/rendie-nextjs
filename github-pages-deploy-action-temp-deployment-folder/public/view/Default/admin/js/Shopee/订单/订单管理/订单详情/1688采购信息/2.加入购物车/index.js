    ...
    addCart: {
        ...
        a02: function (t,oo) {
            let data = [{
                ...
                sql: "select " + Tool.fieldAs("order_items") + " FROM @.table where @.order_sn='" + oo.order_sn + "'",
            }];
            Tool.ajax.a01(data, this.a03, this, oo);
        },
        a03: function (t,oo) {
            let order_items=JSON.parse(t[0][0].order_items);
            let sku = [],items=[];
            for (let i = 0; i < order_items.length; i++) {
                ...
                ////////////////////////////////////////////
               items.push({
                    amount:order_items[i].amount,
                    images:order_items[i].product.images[0],
                    sku:order_items[i].item_model.sku,
                    name:order_items[i].item_model.name,
                    proid:order_items[i].product.sku
                })
            }
            oo.items=items;
            oo.A2 = items.length;
        ...
        a06: function (oo) {  },
        ///////////////////////////////////////////////////////
        b01: function (arr,proid) { //返回1688的来源id
            let _1688_fromid=0;
            for(let i=0;i<arr.length;i++) {
                if(arr[i].proid==proid){
                    _1688_fromid=arr[i]._1688_fromid
                }
            }
            return _1688_fromid;
        },
        ///////////////////////////////////////////////////////
        d01: function (oo) {   
           let _1688_fromid=this.b01(oo.productArr,oo.items[oo.A1 - 1].proid);
           Tool.gatherDetail.a01(_1688_fromid, this.d02, this, oo)
        },
        d02: function (t,oo) {  
            let arr=t.sku.skuProps,cartA1=oo.items[oo.A1 - 1].sku.split("-");
            
            let skuInfoMap=t.sku.skuInfoMap
           Tool.pre(skuInfoMap)

            //let url="https://cart.1688.com/ajax/safe/add_to_cart_list_new.jsx"
            //let body = "type=offer&cargoIdentity=675713561745&returnType=url&needTotalPrice=false&promotionSwitch=false&_csrf_token=72b886e62596818ec774dfdc224d9ae8&t=1747871777908&purchaseType=&ext=%7B%22sceneCode%22%3A%22offerdetail%3Apc%3BipvId%3A2150441f17478717588493857ec8fd%22%7D&specData=%5B%7B%22amount%22%3A1%2C%22specId%22%3A%227fca37f3c127acb72b0496e33ddd32cc%22%2C%22selectedTradeServices%22%3A%5B%5D%7D%5D"
            //gg.postBodyFetch(url, body,"gbk", this.d02, this,oo);
        },
        d03: function (t,oo) { 
...
//https://h5api.m.1688.com/h5/mtop.1688.freightinfoservice.getfreightinfowithscene/1.0/?jsv=2.7.4&appKey=12574478&t=1747872923818&sign=9445663a11ff43ae576f4544a5939640&api=mtop.1688.freightInfoService.getFreightInfoWithScene&v=1.0&type=originaljson&isSec=0&timeout=20000&dataType=jsonp
    //     serviceName: "",
    //     obj:
    //     {
    //         A1: 1, A2: 0, Aarr: [],
