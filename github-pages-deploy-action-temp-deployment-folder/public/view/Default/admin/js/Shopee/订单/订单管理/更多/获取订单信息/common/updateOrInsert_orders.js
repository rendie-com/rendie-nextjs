Object.assign(Tool, {
    ...
    updateOrInsert_orders: {
        a01: function (order, site, num, next, This, t) {
            ...
            this.a02(arrL, arrR, updateArr, site, num, order["@.order_id"], next, This, t)
        },
        a02: function (arrL, arrR, updateArr, site, num, order_id, next, This, t) {
            ...
            let siteNum = Tool.siteNum(site, num);
            let data = [{
                action: "sqlite",
