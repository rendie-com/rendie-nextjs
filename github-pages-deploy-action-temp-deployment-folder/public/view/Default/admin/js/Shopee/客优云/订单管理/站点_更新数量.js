var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header(obj.params.return, 'Shopee &gt; 客优云 &gt; 订单管理 &gt; 站点_更新数量') + '\
        <div class="p-2">\
            <table class="table table-hover">\
            <tbody>\
		        <tr><td class="right w150">状态进度：</td>'+ Tool.htmlProgress('A') + '</tr>\
		        <tr><td class="right">站点：</td><td id="site" colspan="2"></td></tr></tbody>\
    ...
    a03: function () {
        ...
        let data = [{
            ...
            sql: "select count(1) as count FROM @.table where @.country='" + site[0] + "'",
        }]
        $("#state").html("正在统计数量");
