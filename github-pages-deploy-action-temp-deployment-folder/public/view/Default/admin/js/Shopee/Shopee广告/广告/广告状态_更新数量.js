var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header('Shopee &gt; Shopee广告 &gt; 广告 &gt; 广告状态_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let html = '<.Db(sqlite.shopee,select count(1) as total from @.ads where @.site=\'' + obj.arr[5] + '\' and @.state=\'' + this.obj.Aarr[this.obj.A1 - 1][0] + '\',count)/>'
        $("#state").html("正在统计数量");
    ...
    a05: function () {
        config[obj.arr[5]].ads_state_count = this.obj.A2arr;
