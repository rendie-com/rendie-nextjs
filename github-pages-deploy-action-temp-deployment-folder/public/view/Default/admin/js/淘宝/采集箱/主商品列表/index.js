...
var fun =
{
    a01: function () {
        ...
        obj.arr[8] = obj.arr[8] ? obj.arr[8] : "-_-20";//审核前本地状态
        this.a02();
    },
    a02: function () {
        let str = '[<@count/>\
        <r:product size=10 db="sqlite.taobao" page=2 where="'+ this.b09() + '">,\
	    {\
		    "proid":"<:proid/>",\
		    "pic":<:pic tag=0/>,\
    ...
    a03: function (arr) {
        ...
        for (let i = 1; i < arr.length; i++) {
            ...
            <tr>\
                ...
                <td>'+ this.b08(arr[i].AfterReview, Tool.AfterReviewArr) + '</td>\
    ...
    b01: function (oo) {
        ...
        <tr>\
          ...
          <th>首图</th>\
          <th class="p-0">'+ this.b06(obj.arr[7]) + '</th>\
          <th class="p-0">'+ this.b07(obj.arr[8]) + '</th>\
    ...
    b02: function () {
        ...
        <ul class="dropdown-menu">\
	        ...
	        <li onClick="Tool.open4(\'js06\');"><a class="dropdown-item pointer">把【拼多多】和【1688】自动匹配的【详情ID】（相似度）同步过来</a></li>\
        </ul>'
    },
    b03: function (pic) {
        let html = "";
    ...
    b04: function () {
        ...
        <div class="input-group w-50 mb-2">\
            ...
            <ul class="dropdown-menu">\
                ...
                <li class="dropdown-item pointer" onclick="fun.c01(2)" value="2">自动匹配的【详情ID】</a></li>\
            </ul>\
    ...
    b09: function () {
        ...
        if (obj.arr[6] != "-_-20") {
            switch (obj.arr[5]) {
                ...
                case "2": arr.push("@.itemId='" + Tool.unescape(obj.arr[6]) + "'"); break;//自动匹配的【详情ID】
            }
        }
    ...
    b10: function (oo) {
        ...
        <table class="table mb-0 table-bordered">\
            <tr><td title="淘宝的【自动匹配的【详情ID】（相似度）】"><a href="https://item.taobao.com/item.htm?id=' + oo.itemId + '" target="_blank">' + oo.itemId + '</a>（' + oo.itemId_Similarity + '%）</td></tr>\
