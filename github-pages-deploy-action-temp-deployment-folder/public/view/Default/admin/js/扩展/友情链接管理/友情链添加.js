...
$(function(){
  ...
  $('#LinkAdd').click(function(){
		...
		let sql="<rendie:area tag=\"sql\">insert into @.link(:type,:name,:pic,:url,:des,:sort)values ('"+obj2.type+"','"+obj2.name+"','"+obj2.pic+"','"+obj2.url+"','"+obj2.des+"',"+obj2.sort+")</rendie:area>添加成功"
