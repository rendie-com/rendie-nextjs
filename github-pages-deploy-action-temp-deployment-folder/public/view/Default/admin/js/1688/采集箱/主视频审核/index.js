...
var fun =
{
    ...
    a03: function (t) {
        ...
        if (oo) {
            html = '\
            <tr>\
                <td rowspan="2">'+ (oo.list[0].length ? '<video width="100%" height="550" id="myVideo" controls><source src="' + oo.list[0][0].videoUrl + '" type="video/mp4">您的浏览器不支持 HTML5 video 标签。</video>' : '没有视频') + '</td>\
