var fun =
{
    ...
    a01: function () {
        let html = Tool.header(obj.params.return, 'Shopee &gt; 商品列表 &gt; 全球商品_修改 &gt; 人工审核1688主视频状态_更新数量') + '\
        <div class="p-2">\
    ...
    a03: function () {
        let data = [{
                ...
                sql: "select count(1) as total from @.table where @.ManualReview_1688_video_status=" + Tool.ManualReview_1688_video_status[this.obj.A1 - 1][0],
            }
        ]
        $("#state").html("正在统计数量");
    ...
    a05: function () {
        ...
        config.GlobalPro_ManualReview_1688_video_status_count = this.obj.Aarr;
        let data = [{
            action: "fs",
            fun: "writeFile",
