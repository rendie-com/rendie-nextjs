...
var fun =
{
    ...
    a01: function () {
        ...
        //o.params.site          站点
        let html = Tool.header(o.params.return, "Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 更多_all &gt; 获取【店铺商品】详情信息") + '\
        <div class="p-2">\
    ...
    d02: function () {
        ...
        Tool.get_product_info.a01(this.obj.seller, this.obj.Aarr[this.obj.A1 - 1].site, this.obj.B1, "C", this.d03, this);
    },
    d03: function () {
        this.obj.B1++;
        this.d01();
