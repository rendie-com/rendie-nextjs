...
var fun =
{
    ...
    a01: function () {
        ...
        //o.params.site          站点
        let html = Tool.header(o.params.return, "Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 更多_all &gt; 获取【店铺商品】信息") + '\
        <div class="p-2">\
          <table class="table table-hover align-middle mb-0">\
          <tbody>\
		    <tr><td class="right">说明：</td><td colspan="2">会把【shopee/商品/全球商品】数据库的【是否上传】设置为【未上传】，从而重新计算【已传的商品】。</td></tr>\
    ...
    a06: function (site) {
        ...
        let data = [{
            ...
            sql: "update @.table set @.is" + site + "=0",//【是否上传】设置为【未上传】
        }]
    ...
    d02: function () {
        ...
        Tool.get_product_list.a01(this.obj.seller, this.obj.Aarr[this.obj.A1 - 1].site, this.obj.B1, "C", this.d03, this)
    },
    d03: function () {
        this.obj.B1++;
        this.d01();
