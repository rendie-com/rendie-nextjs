...
var fun =
{
    ...
    a01: function () {
        ...
        //o.params.site          站点
        let html = Tool.header(o.params.return, "Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 更多_all &gt; 更新【店铺商品】信息") + '\
        <div class="p-2">\
          <table class="table table-hover align-middle mb-0">\
          <tbody>\
		    <tr><td class="right w200">账号：</td><td id="username" colspan="2"></td></tr>\
		    ...
		    <tr><td class="right">说明：</td><td colspan="2">问：为什么不改修运费信息？答：用默认的就行，我本来就不用改。</td></tr>\
          </tbody>\
    ...
    d02: function () {
        ...
        Tool.C.a01(this.obj.seller, this.obj.Aarr[this.obj.A1 - 1].site, this.obj.B1, "C", this.d03, this)
    },
    d03: function () {
        this.obj.B1++;
        this.d01();
