...
Object.assign(Tool, {
    edit_watermark:
    {
        ...
        a02: function (proid, shopee_8pic, oo) {
            let data = [{
                action: "sqlite",
                database: "shopee/商品/图片/shopee首图/" + Tool.pronum(proid, 100),
            ...
            for (let i = 0; i < shopee_8pic.length; i++) {
                data.push({
                    action: "sqlite",
                    database: "shopee/商品/图片/shopee放大镜图/" + Tool.pronum(proid, 100),
        ...
        a04: function (oo) {
            let data = [{
                action: "sqlite",
                database: "1688/采集箱/商品列表/详情/" + Tool.remainder(oo.manualreview_1688_fromid, 1000),
                sql: "select @.attrpic_shopee as attrpic_shopee FROM @.table where @.fromid=" + oo.manualreview_1688_fromid,
            }]
            //思路：拿1688的水印图片覆盖更新。
        ...
        a05: function (t, oo) {
            ...
            if (arr.length == 0) {
                ...
                let data = [{
                    action: "sqlite",
                    database: "shopee/商品/图片/1688属性图/" + Tool.remainder(oo.manualreview_1688_fromid, 100),
