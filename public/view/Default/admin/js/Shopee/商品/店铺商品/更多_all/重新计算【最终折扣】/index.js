...
var fun =
{
    ...
    a01: function () {
        //o.params.site           站点
        let html = Tool.header(o.params.return, 'Shopee &gt; 商品列表 &gt; 店铺商品 &gt; 更多_all &gt; 重新计算【最终折扣】') + '\
        <div class="p-2">\
          ...
          <tbody>\
            ...
            <tr><td class="right">计算过程：</td><td id="fixedPriceArr" colspan="2"></td></tr>\
            <tr><td class="right">最终折扣：</td><td id="newDiscountArr" colspan="2"></td></tr>\
    ...
    d02: function () {
        ...
        Tool.get_discount.a01(this.obj.seller, this.obj.Aarr[this.obj.A1 - 1].site, this.obj.B1, "C", this.d03, this);
    },
    d03: function () {
        this.obj.B1++;
        this.d01();
