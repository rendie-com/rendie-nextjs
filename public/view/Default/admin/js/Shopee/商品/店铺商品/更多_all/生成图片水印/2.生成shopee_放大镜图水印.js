...
Object.assign(Tool, {
    common2:
    {
        ...
        d01: function (oo) {
            let data = [{
                action: "sqlite",
                database: "shopee/商品/图片/shopee放大镜图/" + Tool.pronum(oo.proid, 100),
                sql: "select " + Tool.fieldAs("width,height," + oo.siteNum + "_watermark") + " FROM @.table where @.src='" + oo.Aarr[oo.A1 - 1] + "'",
                elselist: [{
                    action: "sqlite",
                    database: "shopee/商品/图片/shopee放大镜图/" + Tool.pronum(oo.proid, 100),
                    sql: "INSERT INTO @.table(@.src,@.proid,@.addtime) VALUES ('" + oo.Aarr[oo.A1 - 1] + "','" + oo.proid + "'," + Tool.gettime("") + ")"
                }]
            }];
        ...
        d02: function (t, oo) {
            if (t[0][0][oo.siteNum + "_watermark"] == null) {
                oo.dom.picA.append(this.b01(oo.Aarr[oo.A1 - 1]));
                this.d03(t[0][0], oo);
            }
        ...
        d03: function (o1, oo) {
            let url = "https://s-cf-sg.shopeesz.com/file/" + oo.Aarr[oo.A1 - 1];
            if (o1.width) {
                o1.base64 = url;
                this.e01(o1, oo)
            }
        ...
        e03: function (src, oo) {
            ...
            let data = [{
                action: "sqlite",
                database: "shopee/商品/图片/shopee放大镜图/" + Tool.pronum(oo.proid, 100),
                sql: "update @.table set @." + oo.siteNum + "_watermark='" + src + "'" + sqlstr + " where @.src='" + oo.Aarr[oo.A1 - 1] + "'",
            }]
