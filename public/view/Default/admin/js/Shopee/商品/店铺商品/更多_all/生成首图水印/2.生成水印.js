...
Object.assign(Tool, {
    pic1_waterMark:
    {
        a01: function (proid, _1688_fromid, pic1, key, seller, site, num, siteNum, dom, next, This, t) {
            let oo = {
                proid: proid,
        ...
        a04: function (t, oo) {
            ...
            if (oo.siteNum == "my") {
                ...
                Tool.drawPic1WaterMark.a01(url, t.width, t.height, "https://shopee.vn/khung.vn", oo.key, this.a05, this, oo)
            } else if (oo.siteNum == "vn2") {
        ...
        d01: function (oo) {
            ...
            let data = [{
                ...
                action: "sqlite",
                database: "shopee/商品/图片/1688属性图/" + Tool.remainder(oo._1688_fromid, 100),
                sql: "select " + Tool.fieldAs("width,height,hash,size,addtime") + " FROM @.table where @.src='" + oo.pic1 + "' limit 1",
            }]
