'use strict';
!function () {
    let path = "admin/js/Shopee/营销中心/加购优惠/"
    ...
    switch (o.params.jsFile2) {
        case "01": Tool.scriptArr(loginPath.concat([commonPath, path + '更多_all/获取【加购优惠】信息/common.js', path + '更多_all/获取【加购优惠】信息/index.js'])); break;
