'use strict';
!function () {
    let path = "admin/js/Shopee/营销中心/运费促销/"
    ...
    switch (o.params.jsFile2) {
        case "01": Tool.scriptArr(loginPath.concat([commonPath, path + '更多_all/获取【运费促销】信息/common.js', path + '更多_all/获取【运费促销】信息/index.js'])); break;
