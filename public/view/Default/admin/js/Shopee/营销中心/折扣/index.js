...
var fun =
{
    ...
    a02: function () {
        let data = [{
            ...
            elselist: [{
                action: "fs",
                fun: "download_sqlite",
                urlArr: ["https://raw.githubusercontent.com/rendie-com/rendie-com/refs/heads/main/sqlite3/shopee/营销中心/折扣/" + this.obj.siteNum + ".db"],
                database: "shopee/营销中心/折扣/" + this.obj.siteNum,
            }]
        }]
    ...
    b02: function () {
        ...
        <ul class="dropdown-menu">\
            <li onClick="Tool.openR(\'jsFile=js07&site='+ o.params.site + "&num=" + o.params.num + '\');"><a class="dropdown-item pointer">*获取【折扣】信息</a></li>\
        </ul>'
    },
    b03: function () {
        let arr = [];
