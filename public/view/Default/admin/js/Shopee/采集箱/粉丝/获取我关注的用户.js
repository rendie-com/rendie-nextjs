var fun =
{
    ...
    d02: function () {
        ...
        let url = "https://" + (obj.params.site == "tw" ? "xiapi" : obj.params.site) + ".xiapibuy.com/api/v4/pages/get_followee_list?limit=20&offset=" + ((this.obj.B1 - 1) * 20) + "&shopid=" + this.obj.shopId;
    ...
    e01: function () {
        ...
        config[obj.params.site].is_my_following = this.obj.dbnameObj;
        let data = [{
            action: "fs",
            fun: "writeFile",
