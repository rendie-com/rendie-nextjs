...
!function () {
    ...
    switch (obj.params.jsFile) {
        ...
        case "js02": Tool.scriptArr([path + "common.js", path + '包裹管理/config.js', path + '包裹管理/index.js']); break;
        ...
        case "js14": Tool.scriptArr(["admin/js/Shopee/common.js", path + "common.js", path + '订单管理/config.js', path + '订单管理/index.js']); break;
        case "js15": Tool.scriptArr([path + '账户/修改.js']); break;
        case "js16": Tool.scriptArr(loginPath.concat(['admin/js/1688/common_登录.js', 'admin/js/1688/common.js', path + '包裹管理/更多/把1688运单号同步过来.js'])); break;
        case "js17": Tool.scriptArr([path + '包裹管理/config.js', path + '包裹管理/包裹状态_更新数量.js']); break;
        case "js18": Tool.scriptArr([path + '包裹管理/config.js', path + '包裹管理/时间_更新数量.js']); break;
        ...
        case "js22": Tool.scriptArr([path + '订单管理/config.js', path + '订单管理/状态_更新数量.js']); break;
        case "js23": Tool.scriptArr(["admin/js/Shopee/common.js", path + '订单管理/config.js', path + '订单管理/站点_更新数量.js']); break;
