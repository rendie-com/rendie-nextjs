...
var fun =
{
    ...
    a02: function () {
        let data = [{
            ...
            elselist: [{
                action: "fs",
                fun: "download_sqlite",
                urlArr: ["https://raw.githubusercontent.com/rendie-com/rendie-com/refs/heads/main/sqlite3/shopee/客优云/黑名单.db"],
                database: "shopee/客优云/黑名单",
            }]
        }]
    ...
    b03: function () {
		...
		<ul class="dropdown-menu">\
            <li onClick="Tool.openR(\'?jsFile=js11\');"><a class="dropdown-item pointer">*获取黑名单</a></li>\
		</ul>'
    },
    b04: function () {
        let arr = [];
