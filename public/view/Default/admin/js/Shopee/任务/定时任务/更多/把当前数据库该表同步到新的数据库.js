var fun =
{
    ...
    a02: function () {
        let html = Tool.header(o.params.return, "Shopee &gt; 定时任务 &gt; 更多 &gt; 把当前数据库该表同步到新的数据库") + '\
        <div class="p-2">\
    ...
    a03: function () {
        ...
        let data = [{
            ...
            sql: "select * FROM @." + o.params.table + " order by @.id asc" + Tool.limit(10, this.obj.A1, o.DEFAULT_DB),
        }]
        if (this.obj.A2 == 0) {
            data.push({
                action: o.DEFAULT_DB,
