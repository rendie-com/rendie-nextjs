...
var fun =
{
    ...
    a02: function (id) {
        let str = '{\
        <r:buyer db="sqlite.taobao" size=1 where=" where @.id='+ id + '">\
          "sort":<:sort/>,\
          "fromid":<:fromid/>,\
    ...
    a03: function (oo) {
        let html = '\
        <header class="panel-heading"><a href="javascript:" onclick="Tool.main()" class="arrow_back"></a>淘宝 &gt; 买家账户 &gt; 修改</header>\
        <div class="p-2">\
    ...
    c01: function (This, L, V) {
        ...
        if (val != V && !This.attr("disabled")) {
            ...
            let txt = '""<r: db="sqlite.taobao">update @.buyer set @.' + L + '=\'' + val + '\' where @.id=' + obj.arr[4] + '</r:>'
