...
var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header(obj.params.return, "1688 &gt; 买家订单 &gt; 获取买家【三个月前订单】") + '\
        <div class="p-2">\
    ...
    a04: function () {
        let url = "https://trade.1688.com/order/buyer_order_list.htm?spm=a360q.8274423.0.0.1c324c9aAVIh2O&scene_type=&source=&purchase_company_name=null&product_name=&start_date=&end_date=&seller_login_id=&trade_status=&trade_type_search=&biz_type_search=&order_id_search=&is_his=y&is_hidden_canceled_offer=&apt=&related_code=&order_settle_flag=&company_name=&keywords=&receiver_tel=&receiver_name=&buyer_name=&down_stream_order_id=&batch_number=&total_fee=&page=" + this.obj.A1
        $("#url").html(url);
        gg.getFetch(url, "gbk", this.a05, this)
    },
    a05: function (t) {
        if (t.indexOf("page=" + (this.obj.A2 + 1)) != -1) { this.obj.A2++; }
        this.d01(t)
    },
    /////////////////////////////////////
    b01: function (val, k) {
    ...
    d01: function (t) {
        ...
        for (let i = 0; i < liArr.length; i++) {
            ...
            arr.push({
                orderid: Tool.Trim(Tool.StrSlice(liArr[i], ' <span class="order-id">订单号：', '</span>')),//订单号
