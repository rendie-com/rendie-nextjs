...
var fun =
{
    ...
    a01: function () {
        ...
        let html = Tool.header("1688 &gt; 采集箱 &gt; 正在给【首图】【放大镜图】【属性图】【详情图】搜货源。。。") + '\
        <div class="p-2">\
    ...
    a06: function (picObj, oo) {
        $("#state").html("正在更新数据...");
        let str = '<r: db="sqlite.1688">update @.product set @.pic=' + Tool.rpsql(JSON.stringify(picObj)) + ' where @.proid=\'' + oo.proid + '\'</r:>'
