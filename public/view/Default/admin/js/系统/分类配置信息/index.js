                ...
                <tr>\
                    <th class="w70" style="padding-left: 30px;position: relative;">\
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown0">\
                            ...
                            <li onClick="Tool.openR(\'jsFile=js02&table=config&database=main&toaction=pg01\');"><a class="dropdown-item pointer">*把当前数据库该表同步到【PostgreSQL-pg01】数据库</a></li>\
                            <li onClick="Tool.openR(\'jsFile=js02&table=config&database=main&toaction=pg02\');"><a class="dropdown-item pointer">*把当前数据库该表同步到【PostgreSQL-pg02】数据库</a></li>\
                            <li onClick="Tool.openR(\'jsFile=js02&table=config&database=main&toaction=pg03\');"><a class="dropdown-item pointer">*把当前数据库该表同步到【PostgreSQL-pg03】数据库</a></li>\
                            <li onClick="Tool.openR(\'jsFile=js02&table=config&database=main&toaction=pg04\');"><a class="dropdown-item pointer">*把当前数据库该表同步到【PostgreSQL-pg04】数据库</a></li>\
                        </ul>ID\
                    </th>\
                    <th>分类名称</th>\
                </tr>\
